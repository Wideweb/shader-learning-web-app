...
@Component({
  selector: 'module-cover',
  templateUrl: './module-cover.component.html',
  styleUrls: ['./module-cover.component.css'],
  providers: [{ 
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => ModuleCoverComponent),
    multi: true
   }]
})
export class ModuleCoverComponent implements ControlValueAccessor {
  @Input()
  public label: string = '';
